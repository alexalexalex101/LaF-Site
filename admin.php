...
$returned = $conn->query("SELECT * FROM lost_items WHERE status='returned' ORDER BY id DESC");
?>
                ...
                <div class="admin-detail" id="itemDetail">
                    ...
                    <div id="flexcolumn">
                        ...
                        <div id="flexcolumndiv">
                            ...
                            <!-- Date Returned -->
                            <div id="dateReturnedRow" style="display:none;">
                                <strong>Date Returned:</strong>
                                <span id="detailDateReturned"></span>
                            </div>
                        </div>
                    </div>
                    <!-- Description -->
                    ...
                    <form id="actionForm" method="POST">
                        ...
                        <div class="actions">
                            ...
                            <button type="button" class="return" id="btnReturn">Return Item</button>
